...
let people = Number(numPeople.innerText)
...
const calculateBill = () => {
    ...
    let perPersonTotal = total / people
  
    // update the perPersonTotal on DOM & show it to user
    // toFixed(2) rounds to second decimal place

    perPerson.innerText = '$' + String(perPersonTotal.toFixed(2))
  }
